...
export function PublicEventView({ event, similar = [], preview = false }) {
  const locationLabel = event.location?.name || event.address_public || (event.private_address ? 'Private location' : 'Location coming soon')
