...
function emptyFeed(session, filters) {
  return {
    ...
    fallback: false, fallbackReason: null, rankingVersion: 'supabase-relational-v2',
    experiment: { experiment: 'supabase-relational-v2', variant: 'control', bucket: 0, holdout: false },
