...
async function loadStaticCatalogueNear(session, rawFilters = {}) {
  ...
  if (!Number.isFinite(latitude) || !Number.isFinite(longitude)) {
    return { places: [], fetched: 0, manifest: null, tilesLoaded: 0, tilesRequested: 0, filters, latitude: null, longitude: null, candidateCache: { status: 'bypass' } }
  }
...
function buildFeed(session, state, overlay, timings) {
...
export async function getInfrastructureDiscoveryFeedV2(session, rawFilters = {}) {
