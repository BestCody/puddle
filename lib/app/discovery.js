...
function formatCandidate(session, candidate, ranking) {
  return {
    ...candidate,
...
export async function getDiscoveryFeed(session, rawFilters = {}) {
  ...
  const ranked = evaluated
    ...
    .map(({ candidate }) => formatCandidate(session, candidate, scoreHybridCandidate(candidate, contextResult.context, { filters, experiment: contextResult.experiment, requestId, now })))
