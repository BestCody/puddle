...
const protectedPrefixes = ['/dashboard', '/discover', '/explore', '/plans', '/create', '/studio', '/report', '/friends', '/inbox', '/notifications', '/profile', '/onboarding', '/account', '/wallet', '/orders', '/settings']
...
export async function proxy(request) {
  ...
  if (isAuthOnly && user) return carriesCookies(response, NextResponse.redirect(new URL('/discover', request.url)))
  return response
}
