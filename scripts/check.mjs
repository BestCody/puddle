...
const required = [
  ...
  '.github/workflows/global-location-data.yml','.github/workflows/b2-location-search-smoke.yml','.github/workflows/global-photo-enrichment.yml','.github/workflows/publish-b2-photo-overlay.yml','.github/workflows/global-kartaview-enrichment.yml','.github/workflows/audit-b2-photo-inventory.yml','.github/workflows/repair-b2-photo-inventory.yml','.github/workflows/audit-b2-photo-index-alignment.yml',
