...
const required = [
  ...
  'scripts/b2-upload-tree.mjs','scripts/global-data/mirror_overture.py','scripts/global-data/mirror_fsq_iceberg.py','scripts/global-data/stage_global_sources.py','scripts/global-data/resolve_global_entities.py','scripts/global-data/location_search_common.py','scripts/global-data/build_b2_search_index.py','scripts/global-data/validate_b2_search_index.py','scripts/global-data/build_wikimedia_candidates.py','scripts/global-data/build_mapillary_candidates.py','scripts/global-data/kartaview_urls.py','scripts/global-data/build_kartaview_candidates.py','scripts/global-data/materialize_photo_candidates.py','scripts/global-data/build_b2_photo_search_overlay.py','scripts/global-data/audit_b2_photo_inventory.py','scripts/global-data/repair_b2_photo_inventory.py','scripts/global-data/repair_b2_photo_references.py','scripts/global-data/audit_b2_photo_index_alignment.py',
  '.github/workflows/global-location-data.yml','.github/workflows/b2-location-search-smoke.yml','.github/workflows/global-photo-enrichment.yml','.github/workflows/publish-b2-photo-overlay.yml','.github/workflows/global-kartaview-enrichment.yml','.github/workflows/audit-b2-photo-inventory.yml','.github/workflows/repair-b2-photo-inventory.yml','.github/workflows/repair-b2-photo-references.yml','.github/workflows/audit-b2-photo-index-alignment.yml','.github/workflows/apply-global-photo-candidate-registry.yml',
...
for (const relative of runtimeFiles) {
  ...
  try {
    ...
    // A deleted tracked file remains in `git ls-files` until the change is
    // staged. Do not let that transient index state mask the real runtime
    // coupling check.
