...
requireIncludes(dateSwipeV2, ['SwipeActionDock','onUndo={undo}',"onPass={() => requestChoice('pass', current)}","onSave={() => requestChoice('save', current)}","onPerfect={() => requestChoice('perfect', current)}",'swipe-v2-progress','HomeMoodShortcuts'], 'Immersive swipe workspace')
