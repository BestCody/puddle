...
const required = [
  ...
  'public/landing.html','public/styles.css','public/landing-responsive.css','public/app.js','app/layout.js','app/auth.css','app/onboarding.css','app/date-swipe.css','app/date-match.css','app/product.css','app/stage-two.css','app/stage-three-four.css','app/loading.js','app/error.js',
  ...
  'app/friends/page.js','app/inbox/page.js','app/profile/page.js','app/profile/media/page.js','components/auth-shell.js','components/product-shell.js','components/product-nav.js','components/empty-state.js','components/event-editor.js','components/location-editor.js','components/editor-shared.js','components/revision-history.js','components/public-listing.js','components/media-uploader.js','components/geocode-fields.js','components/discovery-workspace.js','components/date-swipe-workspace.js','components/date-match-workspace.js','components/content-action-button.js','components/attendee-manager.js',
  'lib/supabase/client.js','lib/supabase/server.js','lib/supabase/proxy.js','lib/supabase/admin.js','lib/auth/user.js','lib/auth/redirect.js','lib/security/csrf-client.js','lib/app/stage-one-data.js','lib/app/content-input.js','lib/app/creator-data.js','lib/app/public-content.js','lib/app/geocoding.js','lib/app/discovery.js','lib/app/date-match.js','lib/app/date-match-rules.js','lib/app/plans-data.js','lib/media/pipeline.js',
...
const syntaxFiles = [
  'next.config.mjs','proxy.js','lib/supabase/env.js','lib/supabase/server.js','lib/supabase/proxy.js','lib/supabase/admin.js','lib/auth/redirect.js','lib/app/stage-one-data.js','lib/app/content-input.js','lib/app/creator-data.js','lib/app/public-content.js','lib/app/geocoding.js','lib/app/discovery.js','lib/app/date-match.js','lib/app/date-match-rules.js','lib/app/plans-data.js','lib/media/pipeline.js','scripts/check.mjs','scripts/check-secrets.mjs','scripts/check-client-boundaries.mjs','scripts/check-duplicate-assets.mjs','scripts/check-security-surface.mjs','scripts/check-bundle-size.mjs','scripts/cleanup-orphaned-media.mjs','public/app.js','app/auth/actions.js','app/onboarding/actions.js','app/create/actions.js','app/plans/actions.js','app/report/actions.js','app/api/drafts/[kind]/route.js','app/api/media/upload/route.js','app/api/media/[id]/signed-url/route.js','app/api/geocode/route.js','app/api/discovery/route.js','app/api/discovery/action/route.js','app/api/date-match/start/route.js','app/api/date-match/action/route.js','app/api/date-match/[token]/route.js','app/api/maps/in-view/route.js','app/events/[slug]/calendar/route.js','app/plans/[id]/calendar/route.js','app/auth/callback/route.js','app/auth/confirm/route.js'
]
...
requireIncludes(discoverPage, ["kind: 'place'",'DateSwipeWorkspace','Your 12-card date deck','limit: 12'], 'Date swipe page')
