...
B2_ENDPOINT = os.environ['B2_DATA_S3_ENDPOINT']
B2_KEY_ID = os.environ.get('B2_DATA_KEY_ID') or os.environ['B2_DATA_APPLICATION_KEY_ID']
...
def mirror(row):
    ...
    target_key = f'raw/overture/release={release}/theme=places/type=place/{relative}'
    try:
...
manifest_key = f'raw/overture/release={release}/manifest.json'
