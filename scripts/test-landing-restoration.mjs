...
try {
  ...
  console.log('Revised Figma landing rendered as genuine DOM. Desktop geometry, mobile scroll-triggered Jump In, routes, interactions, responsive overflow, and browser renders passed.')
} finally {
  await browser.close()
