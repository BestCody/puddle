...
export default async function PlanLocationVisitPage({ params, searchParams }) {
  ...
  return renderProductPage(async (session) => {
    const location = await getGlobalLocationBySlug(slug, { traceId: session.traceId || null })
