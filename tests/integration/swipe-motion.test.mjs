...
test('rebuilt Figma swipe card keeps drag, dock, keyboard, durable persistence, and stacked deck motion', () => {
  ...
  assert.match(workspaceSource, /<FigmaSwipeCard item=\{nextCard\} preview busy=\{true\}/)
  ...
  assert.match(motionCss, /\.figma-swipe-card-stage\.is-exiting \.figma-swipe-card\.is-deck-preview/)
  assert.match(motionCss, /@keyframes puddle-figma-next-card-rise/)
})
