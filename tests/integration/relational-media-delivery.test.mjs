...
test('relational discovery keeps legacy object-store media off the browser path', async () => {
  ...
  assert.match(feed, /r2_discovery_overlay_v2/)
  assert.match(feed, /supabase-relational-v3/)
  assert.match(feed, /duplicateKey/)
  assert.doesNotMatch(feed, /discovery_seen_locations_v1|r2_discovery_overlay_v1|static-catalogue|staticCatalogue|Backblaze|b2-private-download|fetchPrivateB2Asset/)
