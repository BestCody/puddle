...
test('private B2 downloads use server-only shareFiles credentials and prefix tokens', async () => {
  ...
  assert.ok(privateClient.includes("fileNamePrefix: prefix"))
  ...
  assert.ok(browserClient.includes('/api/storage/b2-access?prefix='))
